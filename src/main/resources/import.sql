...
INSERT INTO `payment_methods` (`id`, `description`) VALUES (1, 'Credit Card'), (2, 'Debit Card'), (3, 'Cash');
...
INSERT INTO `restaurants_payment_methods` (`restaurant_id`, `payment_method_id`) VALUES (1, 1), (1, 2), (1, 3), (2, 1), (2, 2), (3, 3);