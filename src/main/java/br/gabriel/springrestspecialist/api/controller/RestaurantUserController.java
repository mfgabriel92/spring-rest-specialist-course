...
import br.gabriel.springrestspecialist.api.openapi.controller.RestaurantUserDoc;
...
@RestController
@RequestMapping(path = "/restaurants/{id}/users", produces = MediaType.APPLICATION_JSON_VALUE)
