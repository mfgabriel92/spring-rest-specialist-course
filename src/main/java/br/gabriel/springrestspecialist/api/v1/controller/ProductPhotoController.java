...
import br.gabriel.springrestspecialist.api.mapper.ProductPhotoMapper;
...
import br.gabriel.springrestspecialist.api.v1.openapi.controller.ProductPhotoDoc;
...
@RestController
@RequestMapping(path = "/v1/restaurants/{id}/products/{productId}/photo", produces = MediaType.APPLICATION_JSON_VALUE)
